...
export default function Footer({ onOpenResume }) {
  ...
  return (
    <footer className="border-t border-slate-800/80 bg-[#050811] pt-12 pb-8 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="md:col-span-2 space-y-3">
            <div className="flex items-center gap-2.5 font-mono font-bold text-lg text-white">
          ...
          <div className="space-y-2">
            ...
            <ul className="space-y-1.5 text-xs text-slate-400">
              ...
              <li><a href="#analytics-sandbox" className="hover:text-white transition-colors">Analytics Sandbox</a></li>
              <li><a href="#projects" className="hover:text-white transition-colors">Projects & Repos</a></li>
              <li><a href="#skills" className="hover:text-white transition-colors">Skills Matrix</a></li>
              <li><a href="#experience" className="hover:text-white transition-colors">Education & Certs</a></li>
        ...
        <div className="pt-6 border-t border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <div>
            © {new Date().getFullYear()} Sakthiganesh K. Direct Inbox: <span className="text-slate-400 font-mono">sakthiganeshk27@gmail.com</span>
          </div>
